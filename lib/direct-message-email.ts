    ...
    html: `
      <div style="background:#f5f7ff;padding:32px 16px;font-family:Arial,sans-serif;color:#111827">
        <div style="max-width:560px;margin:0 auto;background:#ffffff;border:1px solid #d9d5ff;border-radius:18px;overflow:hidden">
          ...
          <div style="display:inline-block;background-color:#ffffff!important;border:1px solid #e5e7eb;border-radius:12px;padding:12px 16px;margin:0 0 26px">
            <img src="${LOGO_URL}" width="240" alt="HySky Connect" style="display:block;width:240px;max-width:100%;height:auto" />
          </div>
