...
export default async function FlyingHyPage() {
  ...
  return (
    <PublicShell>
      ...
      <section
        className="flying-hy-hero relative flex flex-col overflow-hidden section-dark"
        style={{
          background: `
              ...
              >
                <div className="absolute inset-0 h-full transition-transform duration-700 ease-out [transform-style:preserve-3d] [-webkit-transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] group-focus:[transform:rotateY(180deg)] motion-reduce:duration-0">
                  ...
                  >
                    ...
                    <h3 className="mb-0.5 break-words text-sm font-bold leading-tight text-white">{speaker.name}</h3>
                    <p className="break-words text-xs font-normal leading-tight text-white/55">{speaker.title}</p>
