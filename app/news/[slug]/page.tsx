  ...
  return (
    <NewsShell>
      ...
      <article className={spaceGrotesk.className} style={{ maxWidth: 780, margin: '0 auto', padding: '42px 28px 88px' }}>
        <Link href={NEWS_ORIGIN} style={{ display: 'inline-flex', color: '#5D00F5', fontSize: '0.86rem', fontWeight: 700, textDecoration: 'none', marginBottom: 34 }}>â† HySky News</Link>
        ...
        {!gated && <div style={{ marginTop: 60, paddingTop: 30, borderTop: '1px solid #ece8f1' }}><Link href={NEWS_ORIGIN} style={{ color: '#5D00F5', fontSize: '0.875rem', fontWeight: 700, textDecoration: 'none' }}>â† More from HySky News</Link></div>}
      </article>
    </NewsShell>
  )
}
